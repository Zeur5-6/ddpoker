        ...
        <div className="text-center space-y-6">
          ...
          {statistics.roundsPlayed > 0 && (
            ...
            >
              ...
              <div>
                <div className="text-gray-400 text-sm">ジャイアントキリング</div>
                <div className="text-2xl font-bold text-orange-400">
                  {statistics.giantKillings}
                </div>
              </div>
              <div>
                <div className="text-gray-400 text-sm">連勝記録</div>
          ...
          >
            <div>
              <h2 className="text-xl font-bold text-white mb-3">対戦相手を選択</h2>
